...
class ServerlessPlugin {
    ...
    loadFixture(fixtureConfig) {
        ...
        if (fixtureConfig.sources && fixtureConfig.sources.length) {
            ...
            promises.push(fixtureConfig.sources.map(source => this.loadSource(source, fixtureConfig.table, this.dynamoFunctions.doc, concurrentWrites, idAutogenerator)));
        }
        ...
        if (fixtureConfig.rawsources && fixtureConfig.rawsources.length) {
            ...
            promises.push(fixtureConfig.rawsources.map(source => this.loadSource(source, fixtureConfig.table, this.dynamoFunctions.raw, concurrentWrites, idAutogenerator)));
        }
